export default function init() {
    // Three-dot row menu — uses [data-row-menu-toggle] inside [data-row-menu]; panel is [data-row-menu-panel].
    // The panel floats with position:fixed anchored to its button, so it escapes
    // the table wrapper's overflow-x-auto clipping (it used to render trapped
    // inside / under the table). Closes on outside-click, Esc, scroll and resize.
